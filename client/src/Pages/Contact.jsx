...
const Contact = () => {
  const [sendData, response] = useSendEmailMutation();
  ...
  const sendEmailHandler = () => {
    sendData({ fullName: sender, email, description });
  };
    ...
    <>
      <section>
        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1 ">
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              <div className="flex flex-col relative">
                ...
                <p className="text-[15px] font-medium text-[#646464]">
                  Addis Ababa, Bole curve 23,
                  <br /> Bahirdar, kebele 13 & kebele 7
                </p>
              </div>
              {/*  */}
              <div className="flex flex-col relative">
              ...
              <div className="flex flex-col relative">
                ...
                <span className="bg-[#ff0336] w-[50px] h-[4px] absolute top-[33px]"></span>
                <div className="text-[18px] font-medium text-gray-700 flex gap-5">
                  <Facebook
                    fontSize="large"
          ...
          {/* second col ---*/}
          <div className="flex flex-col pt-[30px] pr-[50px] pb-[50px] pl-[45px] bg-[#f8f8f8] relative md1000:w-[65%] md1000:flex md1000:flex-col md1000:mx-auto md1000:mt-14 min800:w-[90%] min620:w-full">
            ...
            {pending ? (
              <div
                className="text-white bg-[#ff0336] w-full py-[15px] px-[30px] font-bold text-[14px] uppercase mt-6
              "
              >
                <Loading /> <p className="">Sending...</p>
              </div>
            ) : (
              <button
