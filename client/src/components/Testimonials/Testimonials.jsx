...
function Testimonials() {
  ...
  const clickHandler = (id) => {
    [1, 2, 3].map((e) => {
      ...
      a?.classList?.remove("z-20");
      if (e === id) {
        a?.classList?.add("z-20");
      }
    });
  };
        ...
        <div className="container page-padding">
          ...
          <div className="border-[#efefef] mt-[17rem] md1000:mt-[9rem] bg-white border-solid border-[9px] p-[30px] min540:h-[48rem] min375:h-[60rem]">
            <div className="bg-black overflow-x-clip w-full h-[33rem] relative">
              ...
              <div className="flex ease-in-out duration-200">
                <TestimonialBoxes />
              </div>

              <div className="flex gap-5 absolute bottom-[25px] right-[35px] z-20 min540:-bottom-[52px] min540:right-[17px]">
                <button
                  onClick={() => {
